...
public class DryingRackRecipeCategory implements IRecipeCategory<DryingRackRecipe> {
    ...
    public void draw(DryingRackRecipe recipe, PoseStack matrixStack, double mouseX, double mouseY) {
        ...
        TranslatableComponent dip_time_1 = Component.translatable("gui.jei.category.dipper.dry_time_1");
        TranslatableComponent dip_time_3 = Component.translatable("gui.jei.category.dipper.resultSeconds", dryingTimeString);
