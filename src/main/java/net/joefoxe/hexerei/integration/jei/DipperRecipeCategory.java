...
public class DipperRecipeCategory implements IRecipeCategory<DipperRecipe> {
    ...
    public void draw(DipperRecipe recipe, PoseStack matrixStack, double mouseX, double mouseY) {
        ...
        TranslatableComponent times_dipped_1 = Component.translatable("gui.jei.category.dipper.times_dipped_1");
        TranslatableComponent times_dipped_3 = Component.translatable("gui.jei.category.dipper.result", numberOfDipsString);
...
//        TranslatableComponent dip_time = Component.translatable("gui.jei.category.dipper.dip_time_1", dippingTimeString);
//        minecraft.font.draw(matrixStack, dip_time, 42*1.666f, 27*1.666f, 0xFF808080);
        TranslatableComponent dip_time_1 = Component.translatable("gui.jei.category.dipper.dip_time_1");
        TranslatableComponent dip_time_3 = Component.translatable("gui.jei.category.dipper.resultSeconds", dippingTimeString);
...
//        TranslatableComponent dry_time = Component.translatable("gui.jei.category.dipper.dry_time", dryingTimeString);
//        minecraft.font.draw(matrixStack, dry_time, 42*1.666f, 42*1.666f, 0xFF808080);
        TranslatableComponent dry_time_1 = Component.translatable("gui.jei.category.dipper.dry_time_1");
        TranslatableComponent dry_time_3 = Component.translatable("gui.jei.category.dipper.resultSeconds", dryingTimeString);
