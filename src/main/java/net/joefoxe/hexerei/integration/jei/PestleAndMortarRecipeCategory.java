...
public class PestleAndMortarRecipeCategory implements IRecipeCategory<PestleAndMortarRecipe> {
    ...
    public void draw(PestleAndMortarRecipe recipe, PoseStack matrixStack, double mouseX, double mouseY) {
        ...
        TranslatableComponent dip_time_1 = Component.translatable("gui.jei.category.pestle_and_mortar.grind_time_1");
        TranslatableComponent dip_time_3 = Component.translatable("gui.jei.category.dipper.resultSeconds", grindingTimeString);
